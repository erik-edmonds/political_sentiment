...
created_at TIMESTAMP, notes TEXT, url TEXT, stage TEXT, answer TEXT, candidate_name TEXT, candidate_party TEXT, pct DECIMAL);

copy senate FROM '$PWD/senate_polls.csv' DELIMITER ',' CSV HEADER;
" 
